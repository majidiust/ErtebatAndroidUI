...
public class MainActivity extends BaseActivity {
	...
	private final String[] tabNames = { "گفتگوها", "دوستان", "تماس" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (String tabName : tabNames) {
			...
			mActionBar.addTab(mActionBar.newTab().setCustomView(view).setTabListener(mTabListener));
		}
		if (mCount == 0) {
			mCount++;
	...
	public static class HomePagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			case 2:
				// Inbox.MessageList = new
				// ArrayList<Message>(mParent.loadMessages());
